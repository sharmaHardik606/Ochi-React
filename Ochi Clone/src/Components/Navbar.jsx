...
function Navbar() {
  ...
  return (
    <div
      className={`fixed z-[999] w-full px-[3rem] py-4 font-['Neue Montreal'] flex justify-between items-center backdrop-blur-md transition-transform duration-300 ${
      ...
      <div className="links flex gap-6">
        {['Services', 'Our work', 'About us', 'Insights', 'Contact us'].map(
          (item, index) => (
            <a
              key={index}
              className={`text-base font-regular ${index === 4 && 'ml-36'}`}
            >
              {item}
            </a>
          )
